...
function missionDotIcon(isActive) {
    ...
    return L.divIcon({
        ...
        html: `<div style="width:28px;height:28px;border-radius:50%;background:${color};border:3px solid white;box-shadow:0 3px 10px rgba(0,0,0,0.3);display:flex;align-items:center;justify-content:center;">
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', height: 'calc(100vh - 110px)', gap: 2 }}>
            ...
            <Paper sx={{
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                    ...
                    <Box>
                        <Typography variant="h6" sx={{ color: '#1a1a1a', fontWeight: 800, lineHeight: 1.2 }}>Global Map</Typography>
                ...
                <Stack direction="row" spacing={3} alignItems="center">
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        <Box sx={{ width: 12, height: 12, borderRadius: '50%', bgcolor: '#10B981', border: '2px solid white', boxShadow: '0 0 5px rgba(0,0,0,0.15)' }} />
                        <Typography variant="body2" sx={{ color: '#1a1a1a', fontWeight: 600 }}>Active Drone</Typography>
                    </Box>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        <Box sx={{ width: 12, height: 12, borderRadius: '50%', bgcolor: '#EF4444', border: '2px solid white', boxShadow: '0 0 5px rgba(0,0,0,0.15)' }} />
                        <Typography variant="body2" sx={{ color: '#1a1a1a', fontWeight: 600 }}>Inactive Mission</Typography>
                    </Box>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        <Box sx={{ width: 28, height: 3, background: 'linear-gradient(90deg,#10B981,#6366F1)', borderRadius: 1 }} />
                        <Typography variant="body2" sx={{ color: '#1a1a1a', fontWeight: 600 }}>Flight Path / Polygon</Typography>
                    </Box>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        <Box sx={{ width: 14, height: 14, borderRadius: '50%', border: '2px dashed #F59E0B', bgcolor: alpha('#F59E0B', 0.08) }} />
                        <Typography variant="body2" sx={{ color: '#1a1a1a', fontWeight: 600 }}>Geofence Circle</Typography>
                    </Box>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            ...
            <Paper sx={{
                ...
                {loading && (
                    <Box sx={{ position: 'absolute', inset: 0, zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(255,255,255,0.7)' }}>
